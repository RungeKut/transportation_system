...
# 35 "../Src/stm32f4xx_it.c" 2

# 1 "C:/Keil/blsd_cntl_my/blsd_cntl_my/Inc/stm32f4xx_it.h" 1
# 36 "C:/Keil/blsd_cntl_my/blsd_cntl_my/Inc/stm32f4xx_it.h"
#define __STM32F4xx_IT_H 
# 50 "C:/Keil/blsd_cntl_my/blsd_cntl_my/Inc/stm32f4xx_it.h"
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  if (htim->Instance == ((TIM_TypeDef *) ((0x40000000U + 0x00010000U) + 0x4800U)))
  {
    SwTimer_IntHandler();
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->ICSR |= (1UL << 28U);
  }
  else if (htim->Instance == ((TIM_TypeDef *) ((0x40000000U + 0x00010000U) + 0x4000U)))
  {
...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin)
{
 if (GPIO_Pin == ((uint16_t)0x8000) || GPIO_Pin == ((uint16_t)0x0004) || GPIO_Pin == ((uint16_t)0x0400))
 {
...
void HAL_TIM_TriggerCallback(TIM_HandleTypeDef *htim)
{
 if (htim->Instance == ((TIM_TypeDef *) (0x40000000U + 0x0400U)))
 {
  ...
  HAL_GPIO_TogglePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), ((uint16_t)0x0200));
