...
#define POLL_INPUT(GPIO_REG,GPIO_PIN) do { uint8_t hall_tmp = 0; uint8_t poll_cnt = POLL_CNT; hall_tmp = BIT_BAND_PER(GPIO_REG->IDR, GPIO_PIN); do { if (BIT_BAND_PER(GPIO_REG->IDR, GPIO_PIN) == hall_tmp) { --poll_cnt; } else { hall_tmp = BIT_BAND_PER(GPIO_REG->IDR, GPIO_PIN); poll_cnt = POLL_CNT; } } while (poll_cnt > 0); } while(0)
# 54 "../Src/hall.c"
#define HALL_SENSOR_STATE_TABLE(ENTRY) ENTRY(HALL_RESERVED_0, 0x00) ENTRY(HALL_HAS1, 0x03) ENTRY(HALL_HAS2, 0x01) ENTRY(HALL_HAS3, 0x05) ENTRY(HALL_HAS4, 0x04) ENTRY(HALL_HAS5, 0x06) ENTRY(HALL_HAS6, 0x02) ENTRY(HALL_RESERVED_7, 0x07)
# 64 "../Src/hall.c"
#define EXPAND_AS_HALL_SENSOR_ENUM_POSITION(a,b) a ##_POSITION,
enum {
  HALL_RESERVED_0_POSITION, HALL_HAS1_POSITION, HALL_HAS2_POSITION, HALL_HAS3_POSITION, HALL_HAS4_POSITION, HALL_HAS5_POSITION, HALL_HAS6_POSITION, HALL_RESERVED_7_POSITION,
};

#define EXPAND_AS_HALL_SENSOR_ENUM(a,b) a ##_CODE=b,
enum {
  HALL_RESERVED_0_CODE=0x00, HALL_HAS1_CODE=0x03, HALL_HAS2_CODE=0x01, HALL_HAS3_CODE=0x05, HALL_HAS4_CODE=0x04, HALL_HAS5_CODE=0x06, HALL_HAS6_CODE=0x02, HALL_RESERVED_7_CODE=0x07,
};

#define EXPAND_AS_HALL_SENSOR_STRUCT(a,b) uint8_t hssz_ ##a;
typedef struct {
  uint8_t hssz_HALL_RESERVED_0; uint8_t hssz_HALL_HAS1; uint8_t hssz_HALL_HAS2; uint8_t hssz_HALL_HAS3; uint8_t hssz_HALL_HAS4; uint8_t hssz_HALL_HAS5; uint8_t hssz_HALL_HAS6; uint8_t hssz_HALL_RESERVED_7;
} HallSensorSize_t;

#define NUM_HALL_SENSOR_STATES (sizeof(HallSensorSize_t))

#define EXPAND_AS_HALL_SENSOR_VECTOR(a,b) b,
static const uint8_t hall_sensor_state_vector[(sizeof(HallSensorSize_t))] = {
  0x00, 0x03, 0x01, 0x05, 0x04, 0x06, 0x02, 0x07,
};

#define EXPAND_AS_HALL_SENSOR_OFFSET_VECTOR(a,b) [b] = (uint8_t)offsetof(HallSensorSize_t, hssz_ ##a),
static const uint8_t hall_sensor_offset_vector[(sizeof(HallSensorSize_t))] = {
  [0x00] = (uint8_t)
# 88 "../Src/hall.c" 3 4
 __builtin_offsetof (
# 88 "../Src/hall.c"
...
volatile uint8_t HallStateChanged;

void ChangeHallSensorState(void);
# 122 "../Src/hall.c"
inline void ChangeHallSensorState(void)
{
  (*(volatile uint32_t*)(0x22000000U +32*((uint32_t)((void*)&(HallStateChanged))-0x20000000U)+4*((uint32_t)((0))))) = 1;
...
void HallSensorCB(uint16_t GPIO_Pin)
{
 if (GPIO_Pin == ((uint16_t)0x8000))
 {

  (*(volatile uint32_t*)(0x22000000U +32*((uint32_t)((void*)&(HallState))-0x20000000U)+4*((uint32_t)(0)))) = (*(volatile uint32_t*)(0x42000000U +32*((uint32_t)(&(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U))->IDR))-0x40000000U)+4*((uint32_t)((((uint16_t)0x8000)==0x00000001)? 0 : (((uint16_t)0x8000)==0x00000002)? 1 : (((uint16_t)0x8000)==0x00000004)? 2 : (((uint16_t)0x8000)==0x00000008)? 3 : (((uint16_t)0x8000)==0x00000010)? 4 : (((uint16_t)0x8000)==0x00000020)? 5 : (((uint16_t)0x8000)==0x00000040)? 6 : (((uint16_t)0x8000)==0x00000080)? 7 : (((uint16_t)0x8000)==0x00000100)? 8 : (((uint16_t)0x8000)==0x00000200)? 9 : (((uint16_t)0x8000)==0x00000400)? 10 : (((uint16_t)0x8000)==0x00000800)? 11 : (((uint16_t)0x8000)==0x00001000)? 12 : (((uint16_t)0x8000)==0x00002000)? 13 : (((uint16_t)0x8000)==0x00004000)? 14 : (((uint16_t)0x8000)==0x00008000)? 15 : (((uint16_t)0x8000)==0x00010000)? 16 : (((uint16_t)0x8000)==0x00020000)? 17 : (((uint16_t)0x8000)==0x00040000)? 18 : (((uint16_t)0x8000)==0x00080000)? 19 : (((uint16_t)0x8000)==0x00100000)? 20 : (((uint16_t)0x8000)==0x00200000)? 21 : (((uint16_t)0x8000)==0x00400000)? 22 : (((uint16_t)0x8000)==0x00800000)? 23 : (((uint16_t)0x8000)==0x01000000)? 24 : (((uint16_t)0x8000)==0x02000000)? 25 : (((uint16_t)0x8000)==0x04000000)? 26 : (((uint16_t)0x8000)==0x08000000)? 27 : (((uint16_t)0x8000)==0x10000000)? 28 : (((uint16_t)0x8000)==0x20000000)? 29 : (((uint16_t)0x8000)==0x40000000)? 30 : (((uint16_t)0x8000)==0x80000000)? 31 : 0))));
 }
 else if (GPIO_Pin == ((uint16_t)0x0004))
 {

  (*(volatile uint32_t*)(0x22000000U +32*((uint32_t)((void*)&(HallState))-0x20000000U)+4*((uint32_t)(1)))) = (*(volatile uint32_t*)(0x42000000U +32*((uint32_t)(&(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U))->IDR))-0x40000000U)+4*((uint32_t)((((uint16_t)0x0004)==0x00000001)? 0 : (((uint16_t)0x0004)==0x00000002)? 1 : (((uint16_t)0x0004)==0x00000004)? 2 : (((uint16_t)0x0004)==0x00000008)? 3 : (((uint16_t)0x0004)==0x00000010)? 4 : (((uint16_t)0x0004)==0x00000020)? 5 : (((uint16_t)0x0004)==0x00000040)? 6 : (((uint16_t)0x0004)==0x00000080)? 7 : (((uint16_t)0x0004)==0x00000100)? 8 : (((uint16_t)0x0004)==0x00000200)? 9 : (((uint16_t)0x0004)==0x00000400)? 10 : (((uint16_t)0x0004)==0x00000800)? 11 : (((uint16_t)0x0004)==0x00001000)? 12 : (((uint16_t)0x0004)==0x00002000)? 13 : (((uint16_t)0x0004)==0x00004000)? 14 : (((uint16_t)0x0004)==0x00008000)? 15 : (((uint16_t)0x0004)==0x00010000)? 16 : (((uint16_t)0x0004)==0x00020000)? 17 : (((uint16_t)0x0004)==0x00040000)? 18 : (((uint16_t)0x0004)==0x00080000)? 19 : (((uint16_t)0x0004)==0x00100000)? 20 : (((uint16_t)0x0004)==0x00200000)? 21 : (((uint16_t)0x0004)==0x00400000)? 22 : (((uint16_t)0x0004)==0x00800000)? 23 : (((uint16_t)0x0004)==0x01000000)? 24 : (((uint16_t)0x0004)==0x02000000)? 25 : (((uint16_t)0x0004)==0x04000000)? 26 : (((uint16_t)0x0004)==0x08000000)? 27 : (((uint16_t)0x0004)==0x10000000)? 28 : (((uint16_t)0x0004)==0x20000000)? 29 : (((uint16_t)0x0004)==0x40000000)? 30 : (((uint16_t)0x0004)==0x80000000)? 31 : 0))));
 }
 else if (GPIO_Pin == ((uint16_t)0x0400))
 {

  (*(volatile uint32_t*)(0x22000000U +32*((uint32_t)((void*)&(HallState))-0x20000000U)+4*((uint32_t)(2)))) = (*(volatile uint32_t*)(0x42000000U +32*((uint32_t)(&(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))->IDR))-0x40000000U)+4*((uint32_t)((((uint16_t)0x0400)==0x00000001)? 0 : (((uint16_t)0x0400)==0x00000002)? 1 : (((uint16_t)0x0400)==0x00000004)? 2 : (((uint16_t)0x0400)==0x00000008)? 3 : (((uint16_t)0x0400)==0x00000010)? 4 : (((uint16_t)0x0400)==0x00000020)? 5 : (((uint16_t)0x0400)==0x00000040)? 6 : (((uint16_t)0x0400)==0x00000080)? 7 : (((uint16_t)0x0400)==0x00000100)? 8 : (((uint16_t)0x0400)==0x00000200)? 9 : (((uint16_t)0x0400)==0x00000400)? 10 : (((uint16_t)0x0400)==0x00000800)? 11 : (((uint16_t)0x0400)==0x00001000)? 12 : (((uint16_t)0x0400)==0x00002000)? 13 : (((uint16_t)0x0400)==0x00004000)? 14 : (((uint16_t)0x0400)==0x00008000)? 15 : (((uint16_t)0x0400)==0x00010000)? 16 : (((uint16_t)0x0400)==0x00020000)? 17 : (((uint16_t)0x0400)==0x00040000)? 18 : (((uint16_t)0x0400)==0x00080000)? 19 : (((uint16_t)0x0400)==0x00100000)? 20 : (((uint16_t)0x0400)==0x00200000)? 21 : (((uint16_t)0x0400)==0x00400000)? 22 : (((uint16_t)0x0400)==0x00800000)? 23 : (((uint16_t)0x0400)==0x01000000)? 24 : (((uint16_t)0x0400)==0x02000000)? 25 : (((uint16_t)0x0400)==0x04000000)? 26 : (((uint16_t)0x0400)==0x08000000)? 27 : (((uint16_t)0x0400)==0x10000000)? 28 : (((uint16_t)0x0400)==0x20000000)? 29 : (((uint16_t)0x0400)==0x40000000)? 30 : (((uint16_t)0x0400)==0x80000000)? 31 : 0))));
 }
 MC_IncCommCount();
...
void InitHall(void)
{
 ...
 temp = (*(volatile uint32_t*)(0x42000000U +32*((uint32_t)(&(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U))->IDR))-0x40000000U)+4*((uint32_t)((((uint16_t)0x8000)==0x00000001)? 0 : (((uint16_t)0x8000)==0x00000002)? 1 : (((uint16_t)0x8000)==0x00000004)? 2 : (((uint16_t)0x8000)==0x00000008)? 3 : (((uint16_t)0x8000)==0x00000010)? 4 : (((uint16_t)0x8000)==0x00000020)? 5 : (((uint16_t)0x8000)==0x00000040)? 6 : (((uint16_t)0x8000)==0x00000080)? 7 : (((uint16_t)0x8000)==0x00000100)? 8 : (((uint16_t)0x8000)==0x00000200)? 9 : (((uint16_t)0x8000)==0x00000400)? 10 : (((uint16_t)0x8000)==0x00000800)? 11 : (((uint16_t)0x8000)==0x00001000)? 12 : (((uint16_t)0x8000)==0x00002000)? 13 : (((uint16_t)0x8000)==0x00004000)? 14 : (((uint16_t)0x8000)==0x00008000)? 15 : (((uint16_t)0x8000)==0x00010000)? 16 : (((uint16_t)0x8000)==0x00020000)? 17 : (((uint16_t)0x8000)==0x00040000)? 18 : (((uint16_t)0x8000)==0x00080000)? 19 : (((uint16_t)0x8000)==0x00100000)? 20 : (((uint16_t)0x8000)==0x00200000)? 21 : (((uint16_t)0x8000)==0x00400000)? 22 : (((uint16_t)0x8000)==0x00800000)? 23 : (((uint16_t)0x8000)==0x01000000)? 24 : (((uint16_t)0x8000)==0x02000000)? 25 : (((uint16_t)0x8000)==0x04000000)? 26 : (((uint16_t)0x8000)==0x08000000)? 27 : (((uint16_t)0x8000)==0x10000000)? 28 : (((uint16_t)0x8000)==0x20000000)? 29 : (((uint16_t)0x8000)==0x40000000)? 30 : (((uint16_t)0x8000)==0x80000000)? 31 : 0)))) << 0 |
   (*(volatile uint32_t*)(0x42000000U +32*((uint32_t)(&(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U))->IDR))-0x40000000U)+4*((uint32_t)((((uint16_t)0x0004)==0x00000001)? 0 : (((uint16_t)0x0004)==0x00000002)? 1 : (((uint16_t)0x0004)==0x00000004)? 2 : (((uint16_t)0x0004)==0x00000008)? 3 : (((uint16_t)0x0004)==0x00000010)? 4 : (((uint16_t)0x0004)==0x00000020)? 5 : (((uint16_t)0x0004)==0x00000040)? 6 : (((uint16_t)0x0004)==0x00000080)? 7 : (((uint16_t)0x0004)==0x00000100)? 8 : (((uint16_t)0x0004)==0x00000200)? 9 : (((uint16_t)0x0004)==0x00000400)? 10 : (((uint16_t)0x0004)==0x00000800)? 11 : (((uint16_t)0x0004)==0x00001000)? 12 : (((uint16_t)0x0004)==0x00002000)? 13 : (((uint16_t)0x0004)==0x00004000)? 14 : (((uint16_t)0x0004)==0x00008000)? 15 : (((uint16_t)0x0004)==0x00010000)? 16 : (((uint16_t)0x0004)==0x00020000)? 17 : (((uint16_t)0x0004)==0x00040000)? 18 : (((uint16_t)0x0004)==0x00080000)? 19 : (((uint16_t)0x0004)==0x00100000)? 20 : (((uint16_t)0x0004)==0x00200000)? 21 : (((uint16_t)0x0004)==0x00400000)? 22 : (((uint16_t)0x0004)==0x00800000)? 23 : (((uint16_t)0x0004)==0x01000000)? 24 : (((uint16_t)0x0004)==0x02000000)? 25 : (((uint16_t)0x0004)==0x04000000)? 26 : (((uint16_t)0x0004)==0x08000000)? 27 : (((uint16_t)0x0004)==0x10000000)? 28 : (((uint16_t)0x0004)==0x20000000)? 29 : (((uint16_t)0x0004)==0x40000000)? 30 : (((uint16_t)0x0004)==0x80000000)? 31 : 0)))) << 1 |
   (*(volatile uint32_t*)(0x42000000U +32*((uint32_t)(&(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))->IDR))-0x40000000U)+4*((uint32_t)((((uint16_t)0x0400)==0x00000001)? 0 : (((uint16_t)0x0400)==0x00000002)? 1 : (((uint16_t)0x0400)==0x00000004)? 2 : (((uint16_t)0x0400)==0x00000008)? 3 : (((uint16_t)0x0400)==0x00000010)? 4 : (((uint16_t)0x0400)==0x00000020)? 5 : (((uint16_t)0x0400)==0x00000040)? 6 : (((uint16_t)0x0400)==0x00000080)? 7 : (((uint16_t)0x0400)==0x00000100)? 8 : (((uint16_t)0x0400)==0x00000200)? 9 : (((uint16_t)0x0400)==0x00000400)? 10 : (((uint16_t)0x0400)==0x00000800)? 11 : (((uint16_t)0x0400)==0x00001000)? 12 : (((uint16_t)0x0400)==0x00002000)? 13 : (((uint16_t)0x0400)==0x00004000)? 14 : (((uint16_t)0x0400)==0x00008000)? 15 : (((uint16_t)0x0400)==0x00010000)? 16 : (((uint16_t)0x0400)==0x00020000)? 17 : (((uint16_t)0x0400)==0x00040000)? 18 : (((uint16_t)0x0400)==0x00080000)? 19 : (((uint16_t)0x0400)==0x00100000)? 20 : (((uint16_t)0x0400)==0x00200000)? 21 : (((uint16_t)0x0400)==0x00400000)? 22 : (((uint16_t)0x0400)==0x00800000)? 23 : (((uint16_t)0x0400)==0x01000000)? 24 : (((uint16_t)0x0400)==0x02000000)? 25 : (((uint16_t)0x0400)==0x04000000)? 26 : (((uint16_t)0x0400)==0x08000000)? 27 : (((uint16_t)0x0400)==0x10000000)? 28 : (((uint16_t)0x0400)==0x20000000)? 29 : (((uint16_t)0x0400)==0x40000000)? 30 : (((uint16_t)0x0400)==0x80000000)? 31 : 0)))) << 2;
...
uint8_t GetNextHallSector(uint8_t sector)
{
  ...
  {
    sector_offset = hall_sensor_offset_vector[sector];
    if ( ++sector_offset >= (sizeof(HallSensorSize_t))-1 )
    {
...
void SetHallStateChangeFlag(uint8_t state)
{
  (*(volatile uint32_t*)(0x22000000U +32*((uint32_t)((void*)&(HallStateChanged))-0x20000000U)+4*((uint32_t)((0))))) = (state != 0) ? 1 : 0;
}
...
# 220 "../Src/hall.c"
                    ;
  result = (*(volatile uint32_t*)(0x22000000U +32*((uint32_t)((void*)&(HallStateChanged))-0x20000000U)+4*((uint32_t)((0))))) ? 
# 221 "../Src/hall.c" 3 4
                                                                    1 
# 221 "../Src/hall.c"
                                                                         : 
