...
# 22 "C:/Keil/blsd_cntl_my/blsd_cntl_my/Inc/eprom.h" 2
...
# 40 "../Src/eprom.c"
                                                                          , (uint8_t *)(&(EPROM_Data.GroupCmdTimeOut)), sizeof(EPROM_Data.GroupCmdTimeOut));
 if (status != HAL_OK)
 {
  return status;
 }
...
# 45 "../Src/eprom.c"
                                                                       , (uint8_t *)(&(EPROM_Data.Acceleration)), sizeof(EPROM_Data.Acceleration));
 if (status != HAL_OK)
 {
  return status;
 }
...
# 50 "../Src/eprom.c"
                                                                  , (uint8_t *)(&(EPROM_Data.PoleNum)), sizeof(EPROM_Data.PoleNum));
 if (status != HAL_OK)
 {
  return status;
 }
...
# 55 "../Src/eprom.c"
                                                                       , (uint8_t *)(&(EPROM_Data.FeedBackMode)), sizeof(EPROM_Data.FeedBackMode));
 if (status != HAL_OK)
 {
  return status;
 }
...
# 60 "../Src/eprom.c"
                                                                       , (uint8_t *)(&(EPROM_Data.CurrentLimit)), sizeof(EPROM_Data.CurrentLimit));
 if (status != HAL_OK)
 {
  return status;
 }
...
# 65 "../Src/eprom.c"
                                                                            , (uint8_t *)(&(EPROM_Data.TempearatureLimit)), sizeof(EPROM_Data.TempearatureLimit));
 if (status != HAL_OK)
 {
  return status;
 }
 (*(volatile uint32_t*)(0x22000000U +32*((uint32_t)((void*)&(eprom_ready))-0x20000000U)+4*((uint32_t)(0)))) = 1;
 return status;
}
...
HAL_StatusTypeDef EPROM_Write(uint16_t MemAddress, uint8_t *pdata, uint16_t size)
{
 ...
 do
 {
  ...
  if (MemAddress + size_to_write <= (8))
  {
   result = HAL_I2C_Mem_Write(&hi2c1, (0xA0),
     MemAddress + page_indx * (8), 0x00000001U,
     pdata + page_indx * (8), size_to_write, (100U));
   if (result != HAL_OK)
   {
    break;
   }
  ...
  {
   uint8_t remainder = MemAddress + size_to_write - (8);

   result = HAL_I2C_Mem_Write(&hi2c1, (0xA0),
     MemAddress + page_indx * (8), 0x00000001U,
     pdata + page_indx * (8), size_to_write - remainder, (100U));
   if (result != HAL_OK)
   {
    break;
   }
   result = HAL_I2C_Mem_Write(&hi2c1, (0xA0),
     MemAddress + page_indx * (8) + size_to_write - remainder, 0x00000001U,
     pdata + page_indx * (8) + size_to_write - remainder, remainder, (100U));
   if (result != HAL_OK)
   {
    break;
   }
...
# 126 "../Src/eprom.c"
    EPROM_IsInitialized(void)
{
 return (*(volatile uint32_t*)(0x22000000U +32*((uint32_t)((void*)&(eprom_ready))-0x20000000U)+4*((uint32_t)(0)))) != 0;
}
...
HAL_StatusTypeDef EPROM_Read(uint16_t MemAddress, uint8_t *pdata, uint16_t size)
{
 ...
 result = HAL_I2C_Mem_Read(&hi2c1, (0xA0), MemAddress, 0x00000001U, pdata, size, (100U));
