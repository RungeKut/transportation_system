...
eMBErrorCode eMBRegDiscreteCB( UCHAR * pucRegBuffer, USHORT usAddress,
                                  USHORT usNDiscrete );
# 24 "C:/Keil/blsd_cntl_my/blsd_cntl_my/Inc/spimbaddr.h" 2
# 1 "C:/Keil/blsd_cntl_my/blsd_cntl_my/modbus/include/mbport.h" 1
# 25 "C:/Keil/blsd_cntl_my/blsd_cntl_my/Inc/spimbaddr.h" 2
...
void ProtoInit(void);
# 21 "../Src/spimbaddr.c" 2


typedef struct
{
 
# 25 "../Src/spimbaddr.c" 3 4
_Bool 
# 25 "../Src/spimbaddr.c"
     AddressIsValid;
 uint8_t Address;
...
static inline uint8_t ReadMBAddress(void)
{
 uint8_t i,data;
# 68 "../Src/spimbaddr.c"
 adr_input[0] = HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), ((uint16_t)0x0400));
 adr_input[1] = HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), ((uint16_t)0x0800));
 adr_input[2] = HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), ((uint16_t)0x1000));
 adr_input[3] = HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), ((uint16_t)0x2000));

  for (i=0; i<sizeof(adr_input); i++)
   {
     adr_sym += adr_input[i];
   }
  if (adr_sym > 1 || adr_sym == 0) {MBAddress.AddressIsValid = 
# 77 "../Src/spimbaddr.c" 3 4
                                                              0
# 77 "../Src/spimbaddr.c"
                                                                   ; data = 0;}
  else {
...
static void SaveMBAddress(uint8_t addr)
{
 if (addr != MBAddress.Address)
 {

  {
   ...
   MBAddress.AddressIsValid = 
# 100 "../Src/spimbaddr.c" 3 4
                             1
# 100 "../Src/spimbaddr.c"
                                 ;
...
# 128 "../Src/spimbaddr.c" 3 4
_Bool 
# 128 "../Src/spimbaddr.c"
    GetMBAddress(uint8_t *pAddress)
{
 
# 130 "../Src/spimbaddr.c" 3 4
_Bool 
# 130 "../Src/spimbaddr.c"
     temp_flag = 
# 130 "../Src/spimbaddr.c" 3 4
