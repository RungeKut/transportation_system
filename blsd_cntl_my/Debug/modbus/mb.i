...
# 1 "C:/Keil/blsd_cntl_my/blsd_cntl_my/modbus/include/mbproto.h" 1
# 43 "../modbus/mb.c" 2
# 1 "C:/Keil/blsd_cntl_my/blsd_cntl_my/modbus/include/mbfunc.h" 1
# 32 "C:/Keil/blsd_cntl_my/blsd_cntl_my/modbus/include/mbfunc.h"
#define _MB_FUNC_H 
...
# 1 "C:/Keil/blsd_cntl_my/blsd_cntl_my/modbus/rtu/mbrtu.h" 1
# 32 "C:/Keil/blsd_cntl_my/blsd_cntl_my/modbus/rtu/mbrtu.h"
#define _MB_RTU_H 
...
eMBInit( eMBMode eMode, UCHAR ucSlaveAddress, UCHAR ucPort, ULONG ulBaudRate, eMBParity eParity )
{
    ...
    else
    {
        ...
        case MB_RTU:
            ...
            pvMBFrameCloseCur = 1 ? vMBPortClose : 
# 152 "../modbus/mb.c" 3 4
                                                                  ((void *)0)
# 152 "../modbus/mb.c"
                                                                      ;
    ...
    if( xMBPortEventGet( &eEvent ) == 1 )
    {
        ...
        case EV_EXECUTE:
            ...
            if( ucRcvAddress != ( 0 ) )
            {
                ...
                if( ( eMBCurrentMode == MB_ASCII ) && 2 )
                {
                    vMBPortTimersDelay( 2 );
                }
...
eMBErrorCode
eMBSetAddress(UCHAR ucSlaveAddress)
{
 eMBErrorCode eStatus = MB_ENOERR;
