...
eMBErrorCode eMBRegDiscreteCB( UCHAR * pucRegBuffer, USHORT usAddress,
                                  USHORT usNDiscrete );
# 27 "../modbus/port/porttimer.c" 2
# 1 "C:/Keil/blsd_cntl_my/blsd_cntl_my/modbus/include/mbport.h" 1
# 28 "../modbus/port/porttimer.c" 2
...
# 50 "../modbus/port/porttimer.c"
void MBPortTimerExpiredCB(void)
{

 HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), ((uint16_t)0x0002), GPIO_PIN_RESET);
...
BOOL xMBPortTimersInit(USHORT usTim1Timerout50us)
{
 ...
 if ((hal_status = HAL_TIM_Base_DeInit((&htim9))) != HAL_OK)
 {
  _Error_Handler("../modbus/port/porttimer.c", 64);
 }
 (&htim9)->Init.Period *= usTim1Timerout50us;
 if ((hal_status = HAL_TIM_Base_Init((&htim9))) != HAL_OK)
 {
  _Error_Handler("../modbus/port/porttimer.c", 69);
 }
 mb_delay_timer = SwTimer_Add(SWTIMER_MODE_STOP, MB_DELAY_TIMER_TIMEOUT, 
# 71 "../modbus/port/porttimer.c" 3 4
                                                                        ((void *)0)
# 71 "../modbus/port/porttimer.c"
                                                                            );
...
void vMBPortTimersEnable()
{
 ...
 HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), ((uint16_t)0x0002), GPIO_PIN_SET);

 if (((((&htim9)->Instance->CR1) & ((0x1U << (0U)))) != RESET))
 {
  HAL_TIM_Base_Stop_IT((&htim9));
 }

 (((&htim9))->Instance->CR1|= ((0x1U << (2U))));
 (&htim9)->Instance->EGR = (0x1U << (0U));
 (((&htim9))->Instance->CR1&=~((0x1U << (2U))));
