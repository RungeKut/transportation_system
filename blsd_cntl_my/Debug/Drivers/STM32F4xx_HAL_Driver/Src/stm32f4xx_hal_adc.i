...
# 194 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_adc.c" 2
...
HAL_StatusTypeDef HAL_ADC_Init(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc == 
# 261 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_adc.c" 3 4
            ((void *)0)
...
HAL_StatusTypeDef HAL_ADC_DeInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc == 
# 339 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_adc.c" 3 4
            ((void *)0)
...
# 585 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_adc.c"
HAL_StatusTypeDef HAL_ADC_PollForConversion(ADC_HandleTypeDef* hadc, uint32_t Timeout)
{
