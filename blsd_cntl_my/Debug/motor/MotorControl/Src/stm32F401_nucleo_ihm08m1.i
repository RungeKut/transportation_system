# 1 "../motor/MotorControl/Src/stm32F401_nucleo_ihm08m1.c"
...
# 1 "../motor/MotorControl/Src/stm32F401_nucleo_ihm08m1.c"
# 37 "../motor/MotorControl/Src/stm32F401_nucleo_ihm08m1.c"
...
#define TRUE 1
#define FALSE 0
# 38 "../motor/MotorControl/Src/stm32F401_nucleo_ihm08m1.c" 2
...
# 39 "../motor/MotorControl/Src/stm32F401_nucleo_ihm08m1.c" 2
...
# 39 "C:/Keil/blsd_cntl_my/blsd_cntl_my/motor/MC_6Step_Lib/Inc/stm32_nucleo_ihm08m1.h"
# 1 "C:/Keil/blsd_cntl_my/blsd_cntl_my/motor/MotorControl/Inc/MC_SixStep_param.h" 1
# 59 "C:/Keil/blsd_cntl_my/blsd_cntl_my/motor/MotorControl/Inc/MC_SixStep_param.h"
#define NUM_POLE_PAIRS 11
#define DIRECTION 0
...
# 40 "../motor/MotorControl/Src/stm32F401_nucleo_ihm08m1.c" 2
...
# 75 "../motor/MotorControl/Src/stm32F401_nucleo_ihm08m1.c"
  void MC_SixStep_ADC_Channel(uint32_t adc_ch)
  {
    ((&hadc1)->Instance->CR2 &= ~(0x1U << (0U)));

    hadc1.Instance->SQR3 &= ~(((uint32_t)((uint16_t)((0x1FU << (0U))))) << (5U * ((1) - 1U)));

    hadc1.Instance->SQR3 |= (((uint32_t)((uint16_t)(adc_ch))) << (5U * ((1) - 1U)));
    ((&hadc1)->Instance->CR2 |= (0x1U << (0U)));
  }
# 96 "../motor/MotorControl/Src/stm32F401_nucleo_ihm08m1.c"
...
if(!1)
{
    ...
    sClearInputConfig.ClearInputSource = 0x00000001U;
    sClearInputConfig.ClearInputPolarity = 0x00000000U;
    sClearInputConfig.ClearInputPrescaler = 0x00000000U;
    sClearInputConfig.ClearInputFilter = 0;
    HAL_TIM_ConfigOCrefClear(&htim1, &sClearInputConfig, 0x00000000U);
    HAL_TIM_ConfigOCrefClear(&htim1, &sClearInputConfig, 0x00000004U);
    HAL_TIM_ConfigOCrefClear(&htim1, &sClearInputConfig, 0x00000008U);

}
    (((DBGMCU_TypeDef *) 0xE0042000U)->APB2FZ |= ((0x1U << (0U))));

    ((&htim1)->Instance->DIER |= (((0x1U << (7U)))));
    ...
    sConfig.SamplingTime = ((uint32_t)(0x2U << (0U)));
    HAL_ADC_ConfigChannel(&hadc1, &sConfig);
    ...
    sConfig.SamplingTime = ((uint32_t)(0x2U << (0U)));
    HAL_ADC_ConfigChannel(&hadc1, &sConfig);
    sConfig.Channel = ((uint32_t)(0x04U << (0U)));
    sConfig.SamplingTime = ((uint32_t)(0x4U << (0U)));
    HAL_ADC_ConfigChannel(&hadc1, &sConfig);

  }
# 160 "../motor/MotorControl/Src/stm32F401_nucleo_ihm08m1.c"
  void START_Ref_Generation()
  {
     htim3.Instance->CCR1 = 0;
     htim3.Instance->CCER |= (0x1U << (0U));
  }
# 177 "../motor/MotorControl/Src/stm32F401_nucleo_ihm08m1.c"
  void STOP_Ref_Generation()
  {
     htim3.Instance->CCR1 = 0;
     htim3.Instance->CCER &= ~(0x1U << (0U));
  }
# 194 "../motor/MotorControl/Src/stm32F401_nucleo_ihm08m1.c"
  void Set_Ref_Generation(uint16_t Iref)
  {
    if(!1)
    {
      htim3.Instance->CCR1 = (uint32_t)(Iref * htim3.Instance->ARR)/16384;
    }
    else SIXSTEP_parameters.pulse_value = Iref;
  }
# 214 "../motor/MotorControl/Src/stm32F401_nucleo_ihm08m1.c"
  void START_DAC()
  {

  }
# 229 "../motor/MotorControl/Src/stm32F401_nucleo_ihm08m1.c"
  void STOP_DAC()
  {

  }
# 245 "../motor/MotorControl/Src/stm32F401_nucleo_ihm08m1.c"
  void SET_DAC_value(uint16_t dac_value)
  {

  }
# 283 "../motor/MotorControl/Src/stm32F401_nucleo_ihm08m1.c"
  void HAL_SYSTICK_Callback()
  {

  }
# 319 "../motor/MotorControl/Src/stm32F401_nucleo_ihm08m1.c"
...
# 337 "../motor/MotorControl/Src/stm32F401_nucleo_ihm08m1.c"
...
# 355 "../motor/MotorControl/Src/stm32F401_nucleo_ihm08m1.c"
